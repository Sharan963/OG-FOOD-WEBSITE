  ...
  return (
    <section className="min-h-[90vh] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center px-5 lg:px-14 bg-gradient-to-r from-[#d7e8dc] to-[#c4dbce]">
      ...
      <div className="text-center mt-12 md:text-start md:mt-0 space-y-5 max-w-xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold loading-tight text-gray-900">
          Healthy Eating, <br />
          the Organic Way
        </h1>
        <p className="text-gray-600">
          Discover fresh, organic, and vegetables directly from local farms to
          your kitchen.
        </p>
        <button className="bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-full shadow-lg transition duration-300">Explore Menu</button>
      </div>
