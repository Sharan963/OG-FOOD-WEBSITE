      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            ...
            doorstep. Supporting local farmers and suitable living.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/" className="hover:text-green-600">Dairy Product</a>
            </li>
            <li>
              <a href="/" className="hover:text-green-600">Beverages</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mb-2">123 Organic Street, London, UK</p>
          <p className="text-sm text-gray-600 mb-2">Email: support@organicroot.com</p>
          <p className="text-sm text-gray-600 mb-4">Phone: +44 2255 369 5522</p>
